...
*                                                                             *
\*****************************************************************************/
CPlaneWidget::CPlaneWidget(CBlackBedWidget *parent):CBedDecoratorBase(parent)
{
    ZScale        = 1;
    meshSize      = 12;
    setTestRadius    (70.0);
...
//static double SIN_1=sin(-(M_PI/6.0+M_PI/2.0));
//static double COS_1=cos(-(M_PI/6.0+M_PI/2.0));
